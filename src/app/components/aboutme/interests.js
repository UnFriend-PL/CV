...
export let shortDesc = [
  "I am an inquisitive and determined person who is characterized by the ability to think logically. My interests focus on web development, programming and keeping up with the latest technological developments.",
  "After hours, I enjoy staying active at the gym, exploring the world with a drone and hanging out with friends, as well as developing my programming skills.",
  "In my previous job, I was involved in developing automated tests and applications to support debugging and validation, developing developer tools, and setting up machines.",
  "In addition, I am an active member of the WSB Code research club, where I develop my programming skills and participate in research projects.",
];
export let shortDescPL = [
  "Jestem osobą dociekliwą i zdeterminowaną, która cechuje się zdolnością do logicznego myślenia. Moje zainteresowania skupiają się na tworzeniu stron internetowych, programowaniu oraz śledzeniu najnowszych osiągnięć technologicznych.",
  "Po godzinach lubię aktywnie spędzać czas na siłowni, eksplorować świat za pomocą drona oraz spotykać się z przyjaciółmi, a także rozwijać swoje umiejętności programowania.",
  "W mojej poprzedniej pracy zajmowałem się tworzeniem testów automatycznych i aplikacji wspierających debugowanie i walidację, rozwijaniem narzędzi developerskich oraz konfiguracją maszyn.",
  "Dodatkowo, jestem aktywnym członkiem koła naukowego WSB Code, gdzie rozwijam swoje umiejętności programistyczne i uczestniczę w projektach badawczych.",
];
